...
bool OriginWebSocket::connect(const std::string& host, int port, const std::string& path)
{
    // Create socket
...
bool OriginWebSocket::doHandshake(const std::string& host, const std::string& path)
{
...
std::string OriginWebSocket::receiveText()
{
